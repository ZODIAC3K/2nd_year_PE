...
__all__ = [
    'ISpeechPhraseAlternate', 'DISPID_SLPs_NewEnum',
    'SpeechRuleState', 'SVPNormal', 'DISPID_SVSInputSentencePosition',
    'SPCT_SUB_COMMAND', 'SSSPTRelativeToCurrentPosition',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SGRSTWeight',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SMSSetData',
    'SPAO_RETAIN_AUDIO', 'SPRST_ACTIVE', 'SPAUDIOBUFFERINFO',
    'SPSInterjection', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPEAudioSizeTime', 'DISPID_SAStatus',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRStatus',
    'ISpRecognizer', 'DISPID_SGRName', 'SpeechTokenShellFolder',
    'DISPID_SPAs_NewEnum', 'SpVoice', 'SWTDeleted',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTDisplayUI',
    'SAFT24kHz8BitMono', 'ISpProperties', 'tagSPTEXTSELECTIONINFO',
    'SVPAlert', 'eLEXTYPE_PRIVATE3', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SLWsItem', 'SAFTCCITT_uLaw_11kHzMono', 'SPSModifier',
    'DISPID_SPCLangId', 'SpeechAudioState', 'SDA_Two_Trailing_Spaces',
    'SpeechPropertyResourceUsage', 'DISPID_SOTsItem',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechTokenValueCLSID', 'SINoSignal',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechPhraseInfo',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechPhraseProperties',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRCS_Enabled',
    'SDKLCurrentUser', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechMemoryStream', 'SPFM_CREATE', 'ISpeechRecoResult2',
    'SPVISEMES', 'DISPID_SASetState', 'ISpPhraseAlt',
    'SAFTGSM610_11kHzMono', 'DISPID_SDKDeleteValue', 'SP_VISEME_7',
    'DISPID_SRGRules', 'DISPID_SLPsItem', 'SAFT8kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPVOICESTATUS',
    'SAFT32kHz16BitStereo', 'SPEI_ADAPTATION', 'SP_VISEME_20',
    'SECFDefault', 'SDTAudio', 'DISPID_SPRsCount',
    'SPDKL_CurrentUser', 'ISpGrammarBuilder', 'SVEAllEvents',
    'SPEI_UNDEFINED', 'SpUnCompressedLexicon', 'SPLO_STATIC',
    'SPEI_SR_PRIVATE', 'DISPID_SPRuleFirstElement', 'SRESoundStart',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_RESERVED3', 'SRSInactive',
    'DISPID_SGRs_NewEnum', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRRTStreamTime', 'ISpSerializeState', 'SVP_6', 'SPAS_RUN',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SWTAdded',
    'eLEXTYPE_RESERVED9', 'UINT_PTR', 'DISPID_SOTsCount',
    'ISpPhoneConverter', 'SpeechPropertyNormalConfidenceThreshold',
    'SPBO_PAUSE', 'SAFT11kHz16BitMono', 'SVP_12',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRGDictationSetState', 'SPBO_NONE',
    'SSSPTRelativeToEnd', 'DISPID_SpeechLexiconWords',
    'DISPID_SDKSetLongValue', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SOTId', 'DISPID_SLGetWords', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechLexicon', 'DISPID_SpeechAudioStatus',
    'ISpRecoContext',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTADPCM_8kHzStereo', 'SpeechRecoContextState',
    'SRSActiveAlways', 'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_16',
    'DISPID_SPPChildren', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRAudioInputStream', 'DISPID_SLWType', 'SpMMAudioEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSPhonemeId', 'DISPID_SRCEBookmark',
    'DISPID_SRGetRecognizers', 'DISPID_SGRSTPropertyName',
    'SPCONTEXTSTATE', 'SPSLMA',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechGrammarWordType',
    'SAFTGSM610_44kHzMono', 'SPPROPERTYINFO', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'STCRemoteServer',
    'ISpRecoContext2', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SLAddPronunciation', 'DISPID_SPARecoResult',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechVoice', 'SFTInput',
    'DISPID_SREmulateRecognition', 'SRAONone', 'SVP_21',
    'ISpeechRecoContext', 'SpWaveFormatEx', 'DISPID_SVSpeak',
    'SpInProcRecoContext', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SRSInactiveWithPurge', 'DISPID_SpeechGrammarRule',
    'ISpeechGrammarRule', 'SGLexicalNoSpecialChars', 'ISpShortcut',
    'eLEXTYPE_RESERVED10', 'SPSHORTCUTTYPE', 'LONG_PTR', 'SRAExport',
    'SAFT12kHz8BitMono', 'DISPID_SRRTimes', 'SPEI_WORD_BOUNDARY',
    'SpeechStreamFileMode', 'SP_VISEME_9', 'ISpeechLexicon',
    'DISPID_SMSADeviceId', 'SpTextSelectionInformation',
    'DISPID_SVVoice', 'SpeechDictationTopicSpelling', 'SPEI_PHONEME',
    'SAFT11kHz8BitMono', 'SAFT48kHz16BitMono', 'SAFT8kHz16BitStereo',
    'SVP_13', 'SPPHRASE', 'DISPID_SOTRemove', 'ISpNotifyTranslator',
    'SGPronounciation', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVAudioOutput', 'DISPID_SVSInputWordLength',
    'SPEI_RESERVED6', 'DISPID_SLPSymbolic', 'DISPID_SPPParent',
    'SDKLLocalMachine', 'DISPID_SVSpeakStream', 'DISPID_SGRSTType',
    'DISPID_SpeechGrammarRules', 'SPEI_MIN_SR', 'SSTTWildcard',
    'DISPID_SABIEventBias', 'DISPID_SRGId',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechResourceLoader',
    'ISpRecognizer2', 'SPGRAMMARWORDTYPE', 'SPWF_SRENGINE',
    'SpeechWordType', 'STCInprocHandler', 'DISPID_SRSClsidEngine',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SASNonBlockingIO',
    'DISPID_SGRInitialState', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCSetAdaptationData', 'SSTTTextBuffer', 'SpFileStream',
    'DISPID_SCSBaseStream', 'ISpeechLexiconPronunciation',
    'DISPID_SVIsUISupported', 'DISPID_SpeechRecoContext',
    'DISPID_SGRsCommit', 'DISPID_SDKGetBinaryValue', 'SpCustomStream',
    'SPWORDLIST', 'DISPID_SGRSTNextState', 'SpeechDataKeyLocation',
    'SVSFPersistXML', 'SGRSTTDictation', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_PRIVATE17', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_PRIVATE2', 'SPGS_DISABLED',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPHRASEPROPERTY',
    'DISPID_SPPId', 'DISPID_SWFEAvgBytesPerSec', 'SASRun',
    'DISPID_SFSClose', 'SPEI_MAX_SR', 'DISPID_SVAudioOutputStream',
    'SLOStatic', 'SGDSActive', 'STCAll', 'SpNotifyTranslator',
    'SVSFUnusedFlags', 'SVF_Emphasis', 'SINone', 'SAFT16kHz8BitMono',
    'SVP_11', 'SRTSMLTimeout', 'SpeechVisemeFeature',
    'DISPID_SRCEEnginePrivate', 'SDTReplacement',
    'DISPID_SVEStreamEnd', 'SPFM_NUM_MODES',
    'SpeechWordPronounceable', 'SDA_No_Trailing_Space', 'SVEPrivate',
    'ISpLexicon', 'tagSPPROPERTYINFO', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_0', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRAddResource',
    'DISPID_SPEEngineConfidence', 'SDTRule', 'DISPID_SRGState',
    'ISpeechFileStream', 'SpResourceManager',
    'DISPID_SOTCreateInstance', 'DISPID_SVResume',
    'SPINTERFERENCE_NOISE', 'SPAUDIOSTATE', 'DISPID_SGRClear',
    'SPADAPTATIONRELEVANCE', 'SAFTADPCM_11kHzMono',
    'ISpObjectTokenCategory', 'DISPID_SPERequiredConfidence',
    'SPEI_HYPOTHESIS', 'SPAUDIOOPTIONS', 'eLEXTYPE_PRIVATE6',
    'SPXRO_Alternates_SML', 'SP_VISEME_10', 'SPLOADOPTIONS',
    'SPXRO_SML', 'SVSFParseSsml', 'SGRSTTWildcard',
    'SAFT24kHz16BitMono', 'DISPID_SpeechBaseStream', 'SVEBookmark',
    'SpeechRegistryUserRoot', 'DISPID_SRCRequestedUIType',
    'DISPID_SpeechPhraseElements', 'ISpRecognizer3',
    'eWORDTYPE_DELETED', 'DISPID_SPEActualConfidence',
    'SECFEmulateResult', 'DISPID_SVAlertBoundary', 'SBONone',
    'SSSPTRelativeToStart', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCAudioInInterferenceStatus', 'SRERecoOtherContext',
    'DISPID_SLGenerationId', 'SRCS_Disabled', 'DISPID_SVPause',
    'SAFTADPCM_44kHzStereo', 'SECFNoSpecialChars', 'SPEVENTENUM',
    'SPRST_NUM_STATES', 'DISPID_SRGReset', 'DISPID_SDKGetlongValue',
    'SpeechTokenKeyFiles', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_PRIVATE20', 'SAFT24kHz16BitStereo', 'SpeechRunState',
    'SAFT22kHz16BitStereo', 'SPAO_NONE', 'SPSFunction',
    'ISpRecoCategory', 'SPEVENT', 'SRATopLevel', 'SP_VISEME_2',
    'ISpeechCustomStream', 'SpeechStreamSeekPositionType',
    'SREPrivate', 'SpeechUserTraining', 'SPVPRI_NORMAL',
    'DISPID_SRCRecognizer', 'SWPKnownWordPronounceable', 'SVEPhoneme',
    'SpeechCategoryAudioIn', 'SPEI_PHRASE_START',
    'DISPID_SVSLastBookmark', 'ISpeechMemoryStream', 'SVF_None',
    'eLEXTYPE_PRIVATE7', 'SVP_16', 'SPRULE',
    'DISPID_SRGetPropertyString', 'SRTStandard',
    'SpeechGrammarTagWildcard', 'SPDKL_DefaultLocation',
    'SPINTERFERENCE_NONE', 'DISPID_SLPPhoneIds',
    'DISPID_SGRSTPropertyId', 'SpPhoneConverter',
    'DISPIDSPTSI_SelectionLength', 'SpeechRecognitionType',
    'ISpeechPhraseElement', 'SpAudioFormat', 'eLEXTYPE_PRIVATE4',
    'DISPID_SWFEBitsPerSample', 'SAFT16kHz16BitMono', 'SpStream',
    'SpPhoneticAlphabetConverter', 'DISPID_SRRRecoContext',
    'SITooLoud', 'Speech_StreamPos_RealTime', 'DISPID_SPEsItem',
    'SP_VISEME_11', 'SpObjectToken', 'SPRS_ACTIVE', 'ISpeechDataKey',
    'SVSFParseSapi', 'SPFM_OPEN_READWRITE', 'DISPID_SRRSaveToMemory',
    'DISPID_SPIGrammarId', 'DISPID_SRCEAudioLevel', 'eLEXTYPE_APP',
    'SP_VISEME_17', 'SRTExtendableParse', 'SPEI_VOICE_CHANGE',
    'SpeechAudioFormatGUIDText', 'DISPID_SLWsCount',
    'SpeechAudioVolume', 'SVP_9', 'DISPID_SRCEEndStream',
    'SPCS_ENABLED', 'SLODynamic', 'DISPID_SVEViseme',
    ...
    'SpeechDiscardType', 'DISPID_SpeechPhraseInfo',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechGrammarRuleState',
    'SGDSActiveUserDelimited', 'SPEVENTSOURCEINFO',
    'SAFT12kHz8BitStereo', 'DISPID_SRRSpeakAudio',
    'SpCompressedLexicon', 'Speech_Default_Weight',
    'DISPID_SDKSetStringValue', 'SREBookmark',
    'ISpeechLexiconPronunciations', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCVoice', 'ISpeechRecoResultTimes',
    'DISPID_SASFreeBufferSpace', 'SPEI_SR_BOOKMARK',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPAR_Low',
    'DISPID_SPPValue', 'DISPID_SGRsCount', 'SRAInterpreter',
    'DISPID_SpeechRecognizer', 'DISPID_SVRate',
    'DISPID_SRRDiscardResultInfo', '_SPAUDIOSTATE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechWaveFormatEx',
    'DISPID_SpeechVoiceEvent', 'SPEI_TTS_BOOKMARK',
    'SPEI_RECOGNITION', 'SDTAll', 'DISPID_SLPsCount', 'ISpVoice',
    'DISPID_SRCEInterference', 'DISPID_SGRAddState',
    'DISPID_SVEStreamStart', 'DISPID_SRCCreateResultFromMemory',
    'SRTEmulated', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechObjectToken', 'SPSHT_Unknown',
    'DISPID_SVSInputWordPosition', 'Speech_StreamPos_Asap',
    'SpeechEngineConfidence', 'DISPID_SRCCreateGrammar',
    'SGRSTTEpsilon', 'ISpeechPhraseReplacement', 'SPSHT_EMAIL',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRRSetTextFeedback', 'ISpeechLexiconWord', 'SPWF_INPUT',
    'SRERequestUI', 'DISPID_SRSetPropertyNumber', 'ISpDataKey',
    'SPBO_TIME_UNITS', 'SP_VISEME_1', 'SPRST_INACTIVE_WITH_PURGE',
    'SGDisplay', 'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE15',
    'SWPUnknownWordUnpronounceable', 'SPVPRI_OVER',
    'DISPID_SPRules_NewEnum', 'SVEStartInputStream', 'SVP_17',
    'DISPID_SGRsFindRule', 'SpeechBookmarkOptions',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVP_15',
    'SPSHT_NotOverriden', 'SPPS_Modifier', 'eLEXTYPE_PRIVATE9',
    'eLEXTYPE_PRIVATE16', 'DISPID_SMSAMMHandle', 'SVP_5',
    'SPRST_ACTIVE_ALWAYS', 'SPRULESTATE', 'DISPID_SWFEFormatTag',
    'DISPID_SVGetAudioOutputs', 'eLEXTYPE_PRIVATE1',
    'DISPID_SGRSTsItem', 'SAFT11kHz16BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRCreateRecoContext', 'SREStreamStart', 'SITooQuiet',
    'DISPID_SRRecognizer', 'SPDATAKEYLOCATION',
    'DISPID_SLRemovePronunciation', 'DISPID_SVVolume',
    'DISPID_SRGCmdSetRuleState', 'SpeechRecognizerState',
    'SpeechGrammarState', 'DISPID_SpeechLexiconPronunciation',
    'ISpPhrase', 'DISPID_SGRsCommitAndSave', 'DISPID_SABufferInfo',
    'SAFT8kHz16BitMono', 'ISpeechObjectTokenCategory',
    'SDTLexicalForm', 'SPPS_RESERVED4', 'DISPID_SRCEPhraseStart',
    'SRESoundEnd', 'SVF_Stressed', 'SVP_2', 'eLEXTYPE_RESERVED7',
    'SAFT44kHz16BitMono', 'SpeechPropertyComplexResponseSpeed',
    'SAFT44kHz16BitStereo', 'SVEEndInputStream', 'SRSEIsSpeaking',
    'SPDKL_CurrentConfig', 'DISPID_SRCEPropertyNumberChange',
    'SpeechTokenContext', 'SECLowConfidence', 'SPSMF_SAPI_PROPERTIES',
    'SAFTCCITT_ALaw_44kHzMono', 'eLEXTYPE_PRIVATE5', 'SP_VISEME_18',
    'DISPIDSPTSI', 'DISPID_SPRuleEngineConfidence',
    'ISpStreamFormatConverter', 'Speech_Max_Word_Length',
    'SPVPRI_ALERT', 'DISPID_SRSAudioStatus', 'SPINTERFERENCE_TOOSLOW',
    'ISequentialStream', 'DISPID_SPRNumberOfElements',
    'SPINTERFERENCE_TOOFAST', 'SAFTADPCM_8kHzMono', 'SP_VISEME_14',
    'DISPID_SVSLastStreamNumberQueued', 'SPSHORTCUTPAIR',
    'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechPropertyHighConfidenceThreshold', 'SVP_3',
    'DISPID_SOTCGetDataKey', 'DISPID_SAFSetWaveFormatEx',
    'eLEXTYPE_PRIVATE8', 'SpeechCategoryPhoneConverters',
    'SPWORDTYPE', '_RemotableHandle', 'SRADynamic',
    ...
    'DISPID_SDKEnumValues', 'DISPID_SRSNumberOfActiveRules',
    'SPRECOSTATE', 'DISPID_SPRFirstElement',
    'IInternetSecurityManager', 'SVSFNLPSpeakPunc', 'SP_VISEME_15',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPRDisplayAttributes',
    'SVSFDefault', 'DISPID_SpeechPhraseRules',
    '_ISpeechRecoContextEvents', 'DISPID_SPEAudioStreamOffset',
    'SpMMAudioIn', 'SRSActive', 'SpLexicon', 'SP_VISEME_21',
    'SPBINARYGRAMMAR', 'SpeechCategoryAppLexicons', 'SP_VISEME_13',
    'tagSTATSTG', 'DISPID_SRAudioInput', 'SPPS_Function', 'ISpAudio',
    'Speech_Max_Pron_Length', 'IStream', 'SAFTNoAssignedFormat',
    'eLEXTYPE_PRIVATE12', 'SAFTADPCM_11kHzStereo', 'eLEXTYPE_USER',
    'SASClosed', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPEDisplayAttributes', 'SpeechPartOfSpeech',
    'SP_VISEME_19', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPRsItem', 'SpeechMicTraining', 'DISPID_SPPsItem',
    'SAFT22kHz8BitMono', 'SpMMAudioOut', 'DISPID_SRCRetainedAudio',
    'SpMemoryStream', 'DISPID_SVSkip', 'SPEI_RECO_OTHER_CONTEXT',
    'SpNullPhoneConverter', 'SPAR_Unknown', 'SVP_10', 'SVSFParseMask',
    'SPXMLRESULTOPTIONS', 'IEnumString',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SGRSTText',
    'DISPID_SRCESoundStart', 'SRTAutopause',
    'SpeechPropertyLowConfidenceThreshold', 'SPPS_Noun',
    'DISPID_SRCResume', 'SPAS_PAUSE', 'SPCT_SLEEP',
    'SDKLDefaultLocation', 'SAFT48kHz16BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPPName',
    'DISPID_SVStatus', 'DISPID_SBSSeek', 'DISPIDSPRG',
    'DISPID_SVWaitUntilDone', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPRs_NewEnum', 'SREAllEvents', 'DISPID_SRCEAdaptation',
    'SPAS_CLOSED', 'SPDKL_LocalMachine', 'SVSFPurgeBeforeSpeak',
    'DISPID_SGRsItem', 'SpeechTokenKeyUI', 'ISpeechAudioFormat',
    'SECFIgnoreCase', 'DISPID_SPIAudioSizeBytes',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCESoundEnd',
    'SpeechVoiceCategoryTTSRate', 'SRSEDone', 'SGSEnabled',
    'DISPID_SpeechPhraseBuilder', 'SVEVoiceChange',
    'DISPID_SPPConfidence', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_RESERVED5', 'SVP_1', 'SpStreamFormatConverter',
    'SPWT_LEXICAL', 'DISPID_SPCIdToPhone',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechBaseStream',
    'DISPID_SpeechDataKey', 'SAFTCCITT_uLaw_8kHzMono',
    'STSF_FlagCreate', 'SPRECORESULTTIMES', 'SAFT12kHz16BitMono',
    'DISPID_SLWLangId', 'SpInprocRecognizer', 'ISpeechObjectToken',
    'SPPS_Verb', 'DISPID_SpeechMMSysAudio', 'SAFT32kHz8BitMono',
    'DISPID_SBSRead', 'DISPID_SPIElements', 'SpeechVoiceSpeakFlags',
    'DISPID_SPILanguageId', 'DISPID_SRCERequestUI',
    'SpSharedRecoContext', 'DISPID_SOTCId', 'SGRSTTWord',
    'DISPID_SRRPhraseInfo', 'DISPID_SPIAudioSizeTime',
    'ISpeechAudioBufferInfo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechPhraseReplacements', 'DISPID_SGRSTs_NewEnum',
    'SpeechAudioFormatGUIDWave', 'SPPS_RESERVED3', 'DISPID_SBSWrite',
    'SpeechDisplayAttributes', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPELexicalForm', 'SFTSREngine', 'SSTTDictation',
    'DISPID_SOTCDefault', 'DISPID_SGRSTPropertyValue',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVSRunningState',
    'DISPID_SPACommit', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SADefaultFormat', 'DISPID_SDKGetStringValue',
    'SREPropertyStringChange', 'ISpRecoResult', 'SECNormalConfidence',
    'DISPID_SPIAudioStreamPosition', 'SPEI_RECO_STATE_CHANGE',
    'SVSFIsFilename', 'ISpeechGrammarRuleState', 'SPGS_ENABLED',
    'DISPID_SASCurrentSeekPosition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCVoicePurgeEvent', 'eWORDTYPE_ADDED',
    'SVESentenceBoundary', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechCustomStream', 'SpeechVoicePriority',
    'SREPropertyNumChange', 'DISPID_SOTs_NewEnum', 'SPPHRASEELEMENT',
    'SPPS_SuppressWord', '__MIDL_IWinTypes_0009',
    'DISPID_SRGRecoContext', 'SRARoot', 'DISPID_SpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRRGetXMLResult',
    'DISPID_SVEPhoneme', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPRulesCount', 'SAFT48kHz8BitMono',
    'DISPID_SGRSTransitions', 'SpeechAudioFormatType',
    'DISPID_SPRuleChildren', 'SPPS_RESERVED2',
    'DISPID_SpeechObjectTokens', 'SPEI_START_INPUT_STREAM',
    'SREFalseRecognition', 'eLEXTYPE_PRIVATE10',
    'DISPID_SABIMinNotification', 'SVSFNLPMask', 'DISPID_SRGCommit',
    'eLEXTYPE_PRIVATE11', 'DISPID_SOTDataKey', 'ISpXMLRecoResult',
    'DISPID_SLWPronunciations', 'SpeechRuleAttributes',
    'SAFT24kHz8BitStereo', 'DISPID_SFSOpen',
    'DISPID_SpeechFileStream', 'SPSMF_UPS',
    'SpeechPropertyResponseSpeed', 'SPBO_AHEAD', 'DISPID_SGRSRule',
    'ISpStream', '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_4',
    'SVEWordBoundary', 'SRADefaultToActive', 'SGRSTTRule',
    'SpeechVisemeType', 'SP_VISEME_8', 'SVP_14', 'DISPID_SGRId',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_INTERFERENCE',
    'DISPID_SLGetPronunciations', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SP_VISEME_4', 'DISPID_SDKCreateKey', 'DISPID_SLWs_NewEnum',
    'SINoise', 'SVEViseme', 'DISPID_SPRuleConfidence',
    'SpeechPropertyAdaptationOn', 'SPSHORTCUTPAIRLIST',
    'ISpeechTextSelectionInformation',
    'DISPID_SPERetainedStreamOffset',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_START_SR_STREAM',
    'SAFT44kHz8BitMono', 'SREStreamEnd', 'SRERecognition',
    'ISpRecoGrammar', 'SpPhraseInfoBuilder', 'eLEXTYPE_PRIVATE19',
    'SPSERIALIZEDPHRASE', 'DISPID_SPAsCount', 'DISPID_SPPs_NewEnum',
    'SSFMCreate', 'DISPID_SpeechPhraseReplacement',
    'SGRSTTTextBuffer', 'DISPID_SRDisplayUI', 'SPCT_DICTATION',
    'STCInprocServer', 'SAFT22kHz16BitMono', 'SP_VISEME_3',
    'SpeechAllElements', 'DISPID_SpeechAudioFormat',
    'DISPID_SRGetFormat', 'SpeechAddRemoveWord', 'SPEI_SOUND_START',
    'DISPID_SRSCurrentStreamPosition', 'SPGRAMMARSTATE',
    'DISPID_SPAsItem', 'SPSEMANTICFORMAT', 'SpeechLoadOption',
    'SREAudioLevel', 'SPFM_OPEN_READONLY', 'SAFT8kHz8BitStereo',
    'SPINTERFERENCE', 'SPWT_PRONUNCIATION', 'DISPID_SRCEHypothesis',
    'SP_VISEME_5', 'SpeechVoiceEvents', 'DISPID_SBSFormat',
    'SpeechRecoEvents', 'IEnumSpObjectTokens', 'SPCS_DISABLED',
    'DISPID_SOTGetAttribute', 'SGSDisabled', 'DISPID_SPISaveToMemory',
    'SAFT16kHz16BitStereo', 'DISPID_SDKSetBinaryValue',
    'DISPID_SOTGetStorageFileName', 'SAFTCCITT_ALaw_11kHzStereo',
    'SVSFIsXML', 'SGDSInactive', 'SPAR_High', 'SITooFast',
    'SPEI_MIN_TTS', 'SAFTDefault', 'eLEXTYPE_MORPHOLOGY',
    '_ISpeechVoiceEvents', 'DISPID_SABIBufferSize',
    'DISPID_SRGCmdLoadFromMemory', 'ISpMMSysAudio',
    'DISPID_SGRAttributes', 'SpeechSpecialTransitionType',
    'SPSEMANTICERRORINFO', 'ISpeechVoiceStatus',
    'ISpeechRecognizerStatus', 'SVSFParseAutodetect',
    'SpeechVoiceSkipTypeSentence', 'SpShortcut', 'DISPID_SGRsDynamic',
    'SSFMOpenReadWrite', 'SITooSlow', 'DISPID_SRCCmdMaxAlternates',
    'SVSFIsNotXML', 'SpeechCategoryVoices', 'SPPS_NotOverriden',
    'DISPID_SpeechPhraseAlternates', 'SSFMOpenForRead',
    'DISPID_SAEventHandle', 'SpSharedRecognizer', 'SPEI_RESERVED1',
    'DISPID_SMSGetData', 'SAFTGSM610_22kHzMono',
    'DISPID_SPAStartElementInResult', 'DISPID_SDKEnumKeys',
    'DISPID_SPPEngineConfidence', 'DISPID_SRRTTickCount', 'SVP_19',
    'DISPID_SPPsCount', 'ISpeechPhraseProperties', 'SPEI_TTS_PRIVATE',
    'SVSFlagsAsync', 'DISPID_SGRsAdd', 'ISpeechAudio',
    'STSF_LocalAppData', 'SAFT32kHz16BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'SPSVerb', 'DISPID_SpeechPhoneConverter', 'SPFM_CREATE_ALWAYS',
    'SPEI_VISEME', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRCEStartStream', 'ISpeechLexiconWords', 'SREAdaptation',
    'SWPUnknownWordPronounceable', 'SP_VISEME_12', 'SRAORetainAudio',
    'DISPID_SDKOpenKey', 'ISpObjectWithToken', 'DISPID_SPEsCount',
    'SPPS_LMA', 'SpeechEmulationCompareFlags',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SASState',
    'DISPID_SAVolume', 'SECFIgnoreWidth', 'SDKLCurrentConfig',
    'ISpeechRecoGrammar', 'SAFTGSM610_8kHzMono', 'SPPS_Noncontent',
    'DISPID_SPIRule', 'SPLO_DYNAMIC', 'DISPID_SRGetPropertyNumber',
    'SREInterference', 'DISPID_SRGCmdLoadFromResource',
    'SPPARTOFSPEECH', 'eLEXTYPE_RESERVED4', 'DISPID_SRRAudio',
    'SpeechFormatType', 'DISPID_SRGIsPronounceable',
    'SPEI_REQUEST_UI', 'DISPID_SVESentenceBoundary',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPIDSPTSI_ActiveLength',
    'SPCT_COMMAND', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPIProperties', 'SPPHRASERULE', 'DISPID_SPRuleId',
    'DISPID_SRCEFalseRecognition', 'SpeechCategoryRecoProfiles',
    'STSF_AppData', 'ISpeechObjectTokens', 'SBOPause',
    'DISPID_SpeechAudio', 'DISPID_SWFEExtraData',
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SVGetProfiles',
    'SpeechAudioProperties', 'DISPID_SPIGetText',
    'DISPID_SPEDisplayText', 'SPAR_Medium', 'SPEI_END_INPUT_STREAM',
    'STCLocalServer', 'DISPID_SRRAudioFormat',
    'ISpeechPhraseElements', 'SAFTText', 'SVP_20',
    'DISPID_SPIGetDisplayAttributes', 'SDTAlternates',
    'SVSFVoiceMask', 'SpeechGrammarTagDictation',
    'DISPID_SABufferNotifySize', 'DISPID_SVGetAudioInputs',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRecoProfileProperties',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SMSALineId',
    'SpeechInterference', 'ISpEventSink', 'ISpeechVoice',
    'DISPID_SLPType', 'SPWT_DISPLAY', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRProfile', 'SGDSActiveWithAutoPause',
    'ISpeechPhraseRule', 'DISPID_SRIsUISupported',
    'SpeechCategoryAudioOut', 'eLEXTYPE_RESERVED6',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPERetainedSizeBytes',
    'SVPOver', 'DISPID_SAFType', 'DISPID_SRCEventInterests',
    ...
    'DISPID_SWFEChannels', 'SpeechLexiconType', 'SVP_8',
    'SAFTADPCM_44kHzMono', 'DISPID_SAFGetWaveFormatEx',
    'SPPS_Unknown', 'SPPS_RESERVED1', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRGSetWordSequenceData', 'SVP_18', 'SPRST_INACTIVE',
    'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE14', 'ISpObjectToken',
    'SPTEXTSELECTIONINFO', 'DISPID_SOTCSetId',
    'ISpeechRecoResultDispatch', 'DISPID_SGRSTRule',
    'SPEI_SR_AUDIO_LEVEL', 'SPLEXICONTYPE',
    'DISPID_SLGetGenerationChange', 'ISpeechAudioStatus',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLWWord',
    'SECHighConfidence', 'DISPID_SpeechRecoResult',
    'DISPID_SPEPronunciation', 'ISpeechGrammarRules', 'SLTApp',
    'SVP_7', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVEventInterests', 'DISPID_SpeechLexiconWord',
    'SPAS_STOP', 'DISPID_SPIStartTime', 'SLTUser',
    'ISpResourceManager', 'SpeechCategoryRecognizers',
    'SpObjectTokenCategory', 'SPSHT_OTHER', 'SPWAVEFORMATTYPE',
    'DISPID_SOTIsUISupported', 'SPEI_FALSE_RECOGNITION',
    'SPSNotOverriden', 'DISPID_SGRSTsCount', 'SAFT12kHz16BitStereo',
    'SDTPronunciation', 'DISPID_SpeechPhraseElement',
    'SPCATEGORYTYPE', 'SpeechTokenKeyAttributes',
    'DISPID_SRCBookmark', 'DISPID_SPRuleName',
    'SpeechEngineProperties', 'SVEAudioLevel', 'SSFMCreateForWrite',
    'DISPID_SpeechWaveFormatEx', 'ISpEventSource', 'SP_VISEME_6',
    'SPSNoun', 'IInternetSecurityMgrSite', 'DISPID_SAFGuid',
    'WAVEFORMATEX', 'DISPID_SRRTLength',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRSAddRuleTransition', 'SAFT48kHz8BitStereo',
    'SPEI_SOUND_END', 'SPPHRASEREPLACEMENT', 'SPRS_INACTIVE',
    'SPEI_RESERVED2', 'DISPID_SRGCmdLoadFromObject',
    'SDA_Consume_Leading_Spaces', 'SPSUnknown', 'DISPID_SLPLangId',
    'DISPID_SpeechPhraseReplacements', 'SPGS_EXCLUSIVE',
    'DISPID_SVEWord', 'DISPID_SVDisplayUI', 'DISPID_SPPFirstElement',
    'SREPhraseStart', 'SPRECOGNIZERSTATUS', 'SPEI_MAX_TTS',
    'SPPS_Interjection', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTNonStandardFormat', 'SASPause', 'SPFILEMODE',
    'DISPID_SRCERecognition', 'ISpeechRecognizer',
    ...
    'DISPID_SpeechPhraseRule', 'SDTProperty', 'DISPID_SRState',
    'DISPID_SPAPhraseInfo', 'ISpeechPhraseRules', 'SPAUDIOSTATUS',
    'ISpeechXMLRecoResult', 'DISPID_SVEBookmark',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechRecoResult2',
    'SDA_One_Trailing_Space', 'DISPID_SVSLastResult',
    'SECFIgnoreKanaType', 'DISPID_SPEAudioTimeOffset', 'SPWORD',
    'SVP_0', 'ISpeechPhraseProperty', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_ALaw_8kHzMono', 'SGLexical',
    'ISpeechPhraseInfoBuilder', 'DISPID_SWFESamplesPerSec',
    'STSF_CommonAppData', 'ISpRecoGrammar2', 'DISPID_SPEs_NewEnum',
    'SGSExclusive', 'DISPID_SpeechRecoContextEvents', 'SRAImport',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRGDictationLoad',
    'SPSSuppressWord', 'SAFT11kHz8BitStereo', 'SPVPRIORITY',
    'ISpNotifySource', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRIsShared', 'DISPID_SRCPause',
    'SRTReSent', 'DISPID_SPRuleParent', 'ISpStreamFormat',
    'DISPID_SOTSetId', 'ISpNotifySink', 'SREHypothesis',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SVEAudioLevel',
    'DISPID_SVPriority', 'DISPID_SVSVisemeId', 'DISPID_SPRText',
    'SPEI_END_SR_STREAM', 'ISpeechPhraseAlternates'
]
